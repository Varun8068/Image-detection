...
if __name__ == "__main__":
    ...
    model_path = r"C:\Users\paruc\PycharmProjects\Project1\brain_tumor_model_vgg19.h5"
    ...
    save_path = 'brain_tumor_conf_mat_vgg19.png'

    # Path to save the classification report heatmap
    report_save_path = 'brain_tumor_classification_report_vgg19.png'
